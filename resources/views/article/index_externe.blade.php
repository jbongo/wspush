                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <ul class="nav nav-tabs nav-bordered mb-3">
                            ...
                            <li class="nav-item">
                                <a href="{{route('article.index_externe')}}" data-bs-toggle="tab" aria-expanded="true" class="nav-link active">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane " id="article-interne">
                                {{-- @include('article.article_interne') --}}
                               
                            </div>
                            <div class="tab-pane show active" id="article-externe">
