...
<div class="row">
    <div class="col-sm-10 offset-sm-1">
        <h2 class="page-heading">@lang('Photos visibles sur votre site et dans vos exports')<span id="counter"></span></h2>

        <form method="post" action="{{route('article.store')}}" enctype="multipart/form-data" class="dropzone" id="fileupload">
            {{ csrf_field() }}
...
<div class="row">
    <div class="col-sm-10 offset-sm-1">
        <h2 class="page-heading">@lang('Photos non visibles') {{--<span id="counter">--}}</span></h2>
...
<div class="row">
    ...
    <a href="" id="ajouter" style="width:160px" name="ajouterSeul" class="btn btn-lg btn-success"> @lang('Ajouter')</a>
    </div>
</div>
