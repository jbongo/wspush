        ...
        <div class="col-12 ">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('action.store_duplique')}}" method="post">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="addActionModalLabel">Duplication du titre {{$action->nom}}</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="nom" value="{{old('nom') ? old('nom') : $action->nom .'\' '.($action->id + 1) .'\''}} " id="nom"  required>
                                                @if ($errors->has('nom'))
                                                  <br>
