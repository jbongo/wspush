        ...
        <div class="col-lg-12">
            <div class="card widget-inline">
                <div class="card-body p-0 my-2 mx-2 fw-bold">
                    ...
                    <form action="{{route('ordre_simule.index_vendu', $algo)}}" method="GET">
                        <div class="row">
                ...
                <div class="row">
                    ...
                    {{-- {{dd($algo)}} --}}
                        <p class="text-muted text-primary "  >
                            <a @if($algo != null) href="{{route('ordre_simule.index_vendu',[$algo, 'grid'])}}" @else  href="{{route('ordre_simule.index_vendu','grid')}} "  @endif style="text-decoration: underline; font-size: 15px; ">Changer l'affichage: <i style="font-size: 25px; " class="mdi  mdi-view-grid "></i>  </a> 
                        </p>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="bordered-tabs-preview">
                            <ul class="nav nav-tabs nav-bordered mb-3">
                                <li class="nav-item">
                                    {{-- <a href="{{route('ordre_simule.index_achete',$algo)}}" aria-expanded="false" class="nav-link ">
                                        <span class="d-none d-md-block">Achetés</span>
                                    </a> --}}
                                    <a href="{{str_replace('vendu','achete',$_SERVER['REQUEST_URI'])}}"  aria-expanded="true" class="nav-link ">
                                        <span class="d-none d-md-block">Achetés</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane " id="home-b1x">
                                        ...
                                        <div class="col-xxl-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <table class="table table-centered w-100 dt-responsivexxx nowrap" id="action-vendu-datatable" style="width:100%">
                                                            <thead class="table-lightx" style="background-color: #dc3545; color:#fff;">
                                                                <tr>
                                                                    ...
                                                                    <th scope="col">Val d'Ac (€)</th>
                                                                    <th scope="col">Val de Ve (€)</th>
                                                                    <th scope="col">Qté </th>
