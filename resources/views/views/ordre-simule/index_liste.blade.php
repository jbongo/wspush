        ...
        <div class="col-lg-12">
            <div class="card widget-inline">
                <div class="card-body p-0 my-2 mx-2 fw-bold">
                    ...
                    <form action="{{route('ordre_simule.index', $algo)}}" method="GET">
                        <div class="row">
                ...
                <div class="row">
                    ...
                    {{-- {{dd($algo)}} --}}
                        <p class="text-muted text-primary "  >
                            <a @if($algo != null) href="{{route('ordre_simule.index',[$algo, 'grid'])}}" @else  href="{{route('ordre_simule.index','grid')}} "  @endif style="text-decoration: underline; font-size: 15px; ">Changer l'affichage: <i style="font-size: 25px; " class="mdi  mdi-view-grid "></i>  </a> 
                        </p>
                    </div>
                    <div class="col-4">
                        ...
                        <div class="tab-pane show active" id="bordered-tabs-preview">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="home-b1">
                                    @include('ordre-simule.index_achete_liste')
                                </div>
                                <div class="tab-pane " id="profile-b1">
                                    @include('ordre-simule.index_vendu_liste')                                   
                                </div>
                            </div>                                          
                        </div> <!-- end preview-->
